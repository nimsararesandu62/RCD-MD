...
const regexSend = new RegExp(
  `\\b(?:${["send", "share", "snd", "ewhan", "save", "ewana", "share", "ewanawako", "dpn", "save", "one", "danna", "dannako", "ewanna", "ewannako", "ewpn", "dapan", "danna","send", "share", "snd", "ewhan", "save", "ewana", "share", "ewanawako", "dpn", "save", "one", "danna", "dannako", "ewanna", "ewannako", "ewpn", "dapan", "danna", "oni"].join(
    "|"
  )})\\b`,
  "i"
);
...
smd({ on: "text" }, async (message, text, { icmd }) => {
  try {
    ...
    if (
      ...
      const modifiedPresence =
        waPresence === "composing" ? "running" : waPresence;
      message.bot.sendPresenceUpdate(modifiedPresence, message.from);
    }
